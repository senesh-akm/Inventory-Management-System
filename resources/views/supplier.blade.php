...
@section("title", isset($customer) ? "Edit Supplier" : "Add Supplier")

@section('content')
    <main class="mt-5">
        <h2>{{ isset($customer) ? "Edit Supplier" : "Add Supplier" }}</h2>
            ...
            <div class="row mt-3">
                <div class="col-md-6">
                    <div class="form-group mt-2">
                        ...
                        <input type="text" class="form-control" id="SupplierCode" name="SupplierCode" placeholder="Enter Customer Code" value="{{ isset($customer) ? $customer->CustomerCode : '' }}" required>
                    </div>
                    <div class="form-group mt-2">
                        <label for="SupplierName">Supplier</label>
                        <input type="text" class="form-control" id="SupplierName" name="SupplierName" placeholder="Enter Customer" value="{{ isset($customer) ? $customer->Customer : '' }}" required>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group mt-2">
